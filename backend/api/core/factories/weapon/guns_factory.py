...
from core.classes.character.character import Role
from core.classes.items.weapon import Weapon
from core.classes.items.guns import Guns
from core.character_data.weapons.guns import pistol_data, ammo_pistol_data
